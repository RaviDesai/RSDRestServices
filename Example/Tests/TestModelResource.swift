...
private var users = [
    User(id: uid0, prefix: "Sir", first: "David", middle: "Jon", last: "Gilmour", suffix: "CBE"),
    User(id: uid1, prefix: nil, first: "Roger", middle: nil, last: "Waters", suffix: nil),
    User(id: uid2, prefix: "Sir", first: "Bob", middle: nil, last: "Geldof", suffix: "KBE"),
    User(id: uid3, prefix: "Mr", first: "Nick", middle: "Berkeley", last: "Mason", suffix: nil),
    User(id: uid4, prefix: "", first: "Richard", middle: "William", last: "Wright", suffix: "")
]


class TestModelResource: XCTestCase {
    var called = false
    let runLoop = NSRunLoop.currentRunLoop();
    var loginSite = APISite(name: "Sample", uri: "https://com.desai/")
    var session: APISession?
    var mockStore = MockedRESTStore<User>(host: "com.desai", endpoint: "/api/Users", initialValues: users)
    ...
    func testCreate() {
        ...
        let newUser = User(id: nil, prefix: "Alien", first: "Arthur", middle: nil, last: "Dent", suffix: nil)
        var returnedResponse: User?
        var returnedError: NSError?
    ...
    func testCreateErrorBecauseIDNotNull() {
        XCTAssertTrue(self.mockStore.store.count == 5)
        let newUser = User(id: NSUUID(), prefix: "Alien", first: "Arthur", middle: nil, last: "Dent", suffix: nil)
        var returnedResponse: User?
        var returnedError: NSError?
        newUser.create(self.session!) { (user, error) -> () in
            returnedResponse = user
    ...
    func testDeleteError() {
        XCTAssertTrue(self.mockStore.store.count == 5)
        let userToDelete = User(id: nil, prefix: "Alien", first: "Arthur", middle: nil, last: "Dent", suffix: nil)
        var returnedError: NSError?
